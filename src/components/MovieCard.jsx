...
export default function MovieCard({ movie, index}) {
  return (
    <div className='border-2 rounded-xl flex flex-col flex-auto'>
      ...
      <div className='flex justify-center basis-full'>
        <button className=' rounded-full w-4/5 m-2 h-10 self-end hover:border-blue-400 hover:border bg-slate-200 py-1 px-4 hover:bg-slate-200 hover:text-blue-400'>View details</button>
      </div>
    </div>
  )
}
